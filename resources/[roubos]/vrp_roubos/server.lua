...
local lojadepartamento = "https://discord.com/api/webhooks/1065511420072054866/humM5Nn0JOzopp0QsB3DTBGdICf-UvSSLyv3tbSQfAdlUsAofKGu_spjpQTCdCbejH96"
local registradora = "https://discord.com/api/webhooks/1065511420072054866/humM5Nn0JOzopp0QsB3DTBGdICf-UvSSLyv3tbSQfAdlUsAofKGu_spjpQTCdCbejH96"
local caixa = "https://discord.com/api/webhooks/1065511420072054866/humM5Nn0JOzopp0QsB3DTBGdICf-UvSSLyv3tbSQfAdlUsAofKGu_spjpQTCdCbejH96"
local bancopalleto = "https://discord.com/api/webhooks/1065511420072054866/humM5Nn0JOzopp0QsB3DTBGdICf-UvSSLyv3tbSQfAdlUsAofKGu_spjpQTCdCbejH96"
local banco = "https://discord.com/api/webhooks/1065511420072054866/humM5Nn0JOzopp0QsB3DTBGdICf-UvSSLyv3tbSQfAdlUsAofKGu_spjpQTCdCbejH96"
local AmmuNation = "https://discord.com/api/webhooks/1065511420072054866/humM5Nn0JOzopp0QsB3DTBGdICf-UvSSLyv3tbSQfAdlUsAofKGu_spjpQTCdCbejH96"
...
function sRP.cancelRobbery()
    ...
    if user_id then
        ...
        for l,w in pairs(policia) do
            ...
            if player then
				async(function()
				    TriggerClientEvent("NotifyPush",player,{ code = QRU, title = "Ocorrência", text = "Roubo Cancelado" ..user_id, rgba = {140,35,35} })  
				end)
			end
		end
    end
	...
	for l,w in pairs(policias) do
		...
		if player then
			async(function()
				...
				TriggerClientEvent("NotifyPush",player,{ code = QRU, title = "Ocorrência", text = msg,  x = x, y = y, z = z, name = "Roubo a "..name, rgba = {140,35,35} })
			end)
		end
    end
end