...
-- WEBHOOK
-----------------------------------------------------------------------------------------------------------------------------------------
local webhookjoalheria = "https://discord.com/api/webhooks/985245897619284069/aLUs0YLSYzkxyt2arAg3HRHmWIfUbMMikvCpWsCYr2MAghChXzwCpxNZHM_aL8jFy07J"
	...
	for l,w in pairs(policia) do
		...
		if player then
			async(function()
				...
				TriggerClientEvent("NotifyPush",player,{ code = 10, title = "O roubo começou na Joalheiria, dirija-se até o local e intercepte os assaltantes.", x = x, y = y, z = z, badge = "Joalheiria." })
