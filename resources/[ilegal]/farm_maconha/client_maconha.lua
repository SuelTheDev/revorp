...
Citizen.CreateThread(function()
	...
	while true do
		...
		if GetDistanceBetweenCoords(GetEntityCoords(PlayerPedId()),103.0,6351.44,31.38, true ) <= 1 and not plantado and adubo then
			...
			if IsControlJustPressed(0,38) and emP.permMaconha() and not plantado then
				...
				Entity(pote).state:set('checked', 1, true)
				...
				Entity(pote1).state:set('checked', 1, true)
				...
				SetTimeout(5000,function()
					...
					Entity(pezinho).state:set('checked', 1, true)
					...
					Entity(pezinho1).state:set('checked', 1, true)
					...
					Entity(pezinho2).state:set('checked', 1, true)
				end)
