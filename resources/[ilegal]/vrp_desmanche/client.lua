...
---------------------------------------DESMANCHE 2
local IniciarServico = {177.4, 854.43, 209.38} -- Onde se inicia o serviço e verifica a existência de um carro
local LocalDesmancharCarro = {173.43, 850.48, 209.46} -- Onde deve haver o carro que será desmanchado para poder continuar o desmanche
local LocalFerramentas = {178.2, 848.76, 209.38} -- Local onde 'pegará' as ferramentas
local AnuncioChassi = {147.32, 857.04, 209.35} -- Onde finalizará a missão para entregar o chassi e receber dinheiro e itens
