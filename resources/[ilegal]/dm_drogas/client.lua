...
emP = Tunnel.getInterface("dm_drogas")
-----------------------------------------------------------------------------------------------------------------------------------------
-- VARIAVEIS
-----------------------------------------------------------------------------------------------------------------------------------------
local blips = false
...
-------------------------------------------------------------------------------------------------
local locais = {
	{ ['x'] = 1602.63, ['y'] = 10.38, ['z'] = 165.51 }, --TDTURQUIA MACONHA
	{ ['x'] = -1514.52, ['y'] = 841.18, ['z'] = 186.16 }, --YAKUZA
	{ ['x'] = 1979.69, ['y'] = -950.04, ['z'] = 79.13 }, -- TDALE META
...
RegisterCommand('entregas',function()
	for _,v in pairs(locais) do
		if not servico then
			local ped = PlayerPedId()
			local x,y,z = table.unpack(v)
