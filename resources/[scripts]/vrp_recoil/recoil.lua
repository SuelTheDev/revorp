...
Citizen.CreateThread(function()
	while true do
        ...
        local headshotG3 = HasPedBeenDamagedByWeapon(PlayerPedId(), -1768145561, 0) -- Ilegal
        local headshotAK = HasPedBeenDamagedByWeapon(PlayerPedId(), 961495388, 0) -- Ilegal
		local headshotFive = HasPedBeenDamagedByWeapon(PlayerPedId(), -1075685676, 0) -- Ilegal
		...
		local headshotM4 = HasPedBeenDamagedByWeapon(PlayerPedId(), -2084633992, 0) -- Police
		local headshotMPX = HasPedBeenDamagedByWeapon(PlayerPedId(), -86904375, 0) -- Police
		local headshotGlock = HasPedBeenDamagedByWeapon(PlayerPedId(), 1593441988, 0) -- Police
		local headshotPesada = HasPedBeenDamagedByWeapon(PlayerPedId(), 3523564046, 0) -- Police
		local a, b = GetPedLastDamageBone(PlayerPedId())
		if a and b == 31086 then
			if headshotAK or headshotG3 then
				SetEntityHealth(PlayerPedId(), 101)
			elseif headshotFive or headshotMPX or headshotM4 then
				SetEntityHealth(PlayerPedId(), GetEntityHealth(PlayerPedId()) - 101)
			end
			a, b, headshotAK, headshotG3, headshotMPX, headshotM4, headshotFive, headshotGlock, headshotPesada, headshotSmg2, headshotSig, headshotTec, headshotSmg  = nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil
		end
	end
end)
