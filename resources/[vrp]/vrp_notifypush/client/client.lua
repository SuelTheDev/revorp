...
RegisterCommand("notifys",function(source,args)
	...
	if notifyPolice then
		TriggerEvent("Notify","sucesso","Sucesso","Você ativou o <b>som</b> das notificações policiais.",5000)
	else
		TriggerEvent("Notify","sucesso","Sucesso","Você desativou o <b>som</b> das notificações policiais.",5000)
	end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- NOTIFY
