...
local webhookPontoRota = "https://discord.com/api/webhooks/1069048087571615784/7HQCYnoE42gfJVsHcxG71s-fz5CSXC3gXM2P9O2NbGfxDIb4531AfiFay8J40jST_tT_"
...
local toogleServices = {
	...
	["Coronel RT"] = { out = "PaisanaCoronelRT", sendwebhook = webhookPontoRota },
	["Coronel Folga"] = { _in = "CoronelRT", blip = blips.PMBlip, sendwebhook = webhookPontoRota },

	["Ten. Coronel RT"] = { out = "PaisanaTenCoronelRT", sendwebhook = webhookPontoRota },
	["T. Cel. Folga"] = { _in = "TenCoronelRT", blip = blips.PMBlip, sendwebhook = webhookPontoRota },

	["Capitao RT"] = { out = "PaisanaCapitaoRT", sendwebhook = webhookPontoRota },
	["Capitao Folga"] = { _in = "Major", blip = blips.PMBlip, sendwebhook = webhookPontoRota },

	["Tenente RT"] = { out = "PaisanaTenenteRT", sendwebhook = webhookPontoRota },
	["Tenente Folga"] = { _in = "TenenteRT", blip = blips.PMBlip, sendwebhook = webhookPontoRota },

	["Sargento RT"] = { out = "PaisanaSargentoRT", sendwebhook = webhookPontoRota },
	["Sargento Folga"] = { _in = "SargentoRT", blip = blips.PMBlip, sendwebhook = webhookPontoRota },
