Config = {
	...
	locations = {
		-- (PT) Localização da imobiliária (comprar casas)  -78.66, -802.47, 243.41
		-- (EN) Location to buy houses
		buyLocation = { x = -78.66, y = -802.47, z = 243.41 }
	},
	...
	houseTypes = {
		...
		["Apartament"] = {
			...
			insideLocation = { x = -859.83, y = 691.16, z = 152.87, h = 185.72 },
			chestLocation = { x = -858.27, y = 697.69, z = 145.26, distance = 3 },
			wardrobeLocation = { x = -855.28, y = 679.7, z = 149.06, distance = 3 },

			stealLocations = {
				[1] = { x = -851.17, y = 674.38, z = 152.46, h = 277.8, rewardType = "eletronics" },
				[2] = { x = -860.69, y = 693.17, z = 149.06, h = 53.86, rewardType = "joias" },
				[3] = { x = -851.17, y = 677.25, z = 149.09, h = 277.8, rewardType = "roupas" },
				[4] = { x = -850.95, y = 673.46, z = 149.08, h = 280.63, rewardType = "pessoal" },
				[5] = { x = -863.09, y = 693.43, z = 145.26, h = 90.71, rewardType = "eletronics" },
				[6] = { x = -862.94, y = 699.91, z = 145.26, h = 113.39, rewardType = "pessoal" },
			}
		},
		["Apartament2"] = {
			description = "Os interiores mais sofisticados disponíveis. Alto luxo, garagem e afins.",
	...
	houseList = {
		...
		["FH13"] = {
			name = "Mansão FH13", --  -989.80,525.66,72.72
			type = "Apartament",
			entrada = {
				['x'] = -989.80,
				['y'] = 525.66,
...
-----------------------------------------------------------------------------------------------------------------------------------------
		...
		-- 	type = "Simples",
		-- 	entrada = {
		-- 		['x'] = -526.04, -- -526.04, 2004.43, 205.99
		-- 		['y'] = 2004.43,
		-- 		['z'] = 205.99
		-- 	},
		-- 	price = 350000
