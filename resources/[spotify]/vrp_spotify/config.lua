...
cfg.zones = {
	...
	-- 	coords = vector3(840.24,-945.03,26.49), -- the position where the music is played
	...
	-- 	deflink = "https://www.youtube.com/watch?v=VrZRVlNFxh4",-- the default link, if nill it won't play nothing
	...
	-- 	changemusicblip = vector3(840.24,-945.03,26.49) -- where the player can change the music
	-- },
	-- {
	...
	-- 	range = 30.0, -- the range that music can be heard
	-- 	volume = 0.1, --default volume? min 0.00, max 1.00
	-- 	deflink = "https://www.youtube.com/watch?v=0jKhDGApZDw",-- the default link, if nill it won't play nothing
