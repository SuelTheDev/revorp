...
config.permKick = "dono.permissao" -- Permissao para kickar os jogadores da arena
...
config.arenas = {
    [1] = { 
        ...
        descricacao = "<b>Arma:</b> Pistola MK2 <br> <b>Tempo:</b> 999 Minutos<br> <b>Vagas:</b> 20 Vagas<br> <b>Aposta Minima:</b> R$ 500 <br><b>Para Sair:</b> /pvpoff", -- Descricao da NUI
        ...
        coords = { -- CORDENADAS DE SPAWNS NA ARENA
            [1] = vector3(4463.29,-4460.07,4.12),
            [2] = vector3(4477.02,-4460.77,4.25)
        }
    },
    [2] = { 
