--[BrennoC2N#2626 BrennoC2N#2626 BrennoC2N#2626 BrennoC2N#2626 BrennoC2N#2626 BrennoC2N#2626 BrennoC2N#2626 BrennoC2N#2626 BrennoC2N#2626 BrennoC2N#2626 BrennoC2N#2626 BrennoC2N#2626]--
local opened = false
...
RegisterCommand("taskbar",function(source,args,rawCommand)
    local taskResult = exports['c2n_taskbar']:getTaskBar("dificil","C2N Taskbar")
    if taskResult then
        print("Sucesso")
    else
        print("Falhou")
