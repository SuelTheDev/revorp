...
Config.Debug = false -- habilitar mensagens de depuração no console sv / cl
Config.TestTicker = nil -- necessidade de testar os números, você pode alterar a marca de correção da roleta por / rultick [1-38]

Config.RouletteStart = 30 -- quantos segundos para iniciar a régua depois de se sentar

Config.ItemName = "ficha"

Config.RulettTables = {
    -- você pode implementar tabelas facilmente ou excluí-las.
    [0] = {
