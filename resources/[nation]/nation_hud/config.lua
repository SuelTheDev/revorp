...
config = {
    ...
    getHealth = function(ped) -- calculo da vida
        return ((GetEntityHealth(ped) - 100) * 100 / 300) / 100 -- para vida de 100 até 400
    end,
    ...
    radarOnlyInVehicle = false, -- mostrar minimapa apenas dentro do veiculo
    ...
    tokovoip = false, -- se usa tokovoip coloca true
