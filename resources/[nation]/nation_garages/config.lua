...
---------------------------baby
	...
	---VEICULOS NOVOS ORGS---
	{ hash = -970634648, name = 'amggt63', price = 0, banido = true, modelo = 'amggt63', capacidade = 100, tipo = 'exclusive' },
	{ hash = 1343190773, name = 'xtgang', price = 0, banido = true, modelo = 'xtgang', capacidade = 10, tipo = 'motos' },
	{ hash = -883244519, name = 'xre300', price = 0, banido = true, modelo = 'xre300', capacidade = 10, tipo = 'motos' },
	{ hash = -1702326766, name = 'corolla', price = 0, banido = true, modelo = 'corolla', capacidade = 100, tipo = 'br' },
	{ hash = 765381769, name = 'r1250policia', price = 0, banido = true, modelo = 'r1250policia', capacidade = 0, tipo = 'job' },
	{ hash = -1302786231, name = 'cdac7', price = 0, banido = true, modelo = 'cdac7', capacidade = 100, tipo = 'job' },
	{ hash = 13763442, name = 'cdaranger', price = 0, banido = true, modelo = 'cdaranger', capacidade = 100, tipo = 'job' },
	{ hash = 1151599972, name = 'cdapassat', price = 0, banido = true, modelo = 'cdapassat', capacidade = 100, tipo = 'work' },
	{ hash = 1141894850, name = 'lp770cop', price = 0, banido = true, modelo = 'lp770cop', capacidade = 100, tipo = 'work' },
