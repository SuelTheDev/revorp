...
config.logo = "https://cdn.discordapp.com/attachments/1070497364802031627/1071738402946429028/logorev.png" -- LOGO DO SERVIDOR
...
config.maxDistance = 600 -- distância máxima (em radius(raio)) que o player poderá ir quando estiver realizando o test drive

config.porcentagem_aluguel = 3 -- porcentagem do valor do veículo paga para alugar
...
config.conceClasses = {
	...
	{ class = "vip", img = "https://cdn.discordapp.com/attachments/1070497364802031627/1072043871200088114/max-makarov-urbanbny-gtr34-2.jpg" },
}

-- IMAGEM QUE APARECE NA SEÇÃO DE 'MEUS VEÍCULOS'

config.myVehicles_img = "https://cdn.discordapp.com/attachments/1070497364802031627/1072045348912123914/425705716_preview_2015-07-15_00024.jpg"
...
config.miscIcons = {
	{ description = "Força e velocidade necessárias para aquela dose de adrenalina.", img = "https://cdn.discordapp.com/attachments/1070497364802031627/1072052005335478294/carro.png" },
	{ description = "Incríveis opções econômicas que cabem no seu bolso!", img = "https://cdn.discordapp.com/attachments/1070497364802031627/1072052005528420444/seguro-de-automovel.png" },
	{ description = "Para você que valoriza a eficácia e praticidade.", img = "https://cdn.discordapp.com/attachments/1070497364802031627/1072052005771681813/chave-do-carro.png" },
}
...
-----------------------------------------------------------------------------------------------------------------------------------------
	...
	{ hash = -865546683, name = 'golfsportline', price = 350000, banido = false, modelo = 'Golf Sportline', capacidade = 10, tipo = 'carros', slots = 10, rentalPrice = nil, class = "vip"  },
	{ hash = -2019386221, name = 'golfgti', price = 2000000, banido = false, modelo = 'Golf GTI', capacidade = 50, tipo = 'carros', slots = 10, rentalPrice = nil, class = "vip"  },
	{ hash = 1125130375, name = 'polo', price = 200000, banido = false, modelo = 'Gol', capacidade = 50, tipo = 'carros', slots = 10, rentalPrice = nil, class = "vip"  },
	{ hash = 493030188, name = 'amarok', price = 155500, banido = false, modelo = 'Amarok', capacidade = 300, tipo = 'carros', slots = 10, rentalPrice = nil, class = "vip"  },
	{ hash = 1978088379, name = 'lancerevolutionx', price = 900000, banido = false, modelo = 'Lancer Evolution', capacidade = 100, tipo = 'carros', slots = 30, rentalPrice = nil, class = "vip"  },
...
-----------------------------------------------------------------------------------------------------------------------------------------
	...
	{ hash = 109912402, name = 'audia3', price = 1500000, banido = false, modelo = 'Audi A3', capacidade = 80, tipo = 'carros', slots = 10, rentalPrice = nil, class = "sedan"  },
	{ hash = -440972578, name = 'jetta2017', price = 250000, banido = false, modelo = 'Jetta', capacidade = 20, tipo = 'carros', slots = 10, rentalPrice = nil, class = "sedan"  },
	{ hash = -494839908, name = 'a6', price = 2500000, banido = false, modelo = 'Audi A6', capacidade = 10, tipo = 'carros', slots = 10, rentalPrice = nil, class = "sedan"  },
	{ hash = -716824881, name = 'civicsi', price = 360000, banido = false, modelo = 'Civic Si', capacidade = 10, tipo = 'carros', slots = 10, rentalPrice = nil, class = "sedan "  },
	{ hash = -622126799, name = 'jettagli', price = 330000, banido = false, modelo = 'Jetta Gli', capacidade = 80, tipo = 'carros', slots = 10, rentalPrice = nil, class = "sedan"  },
	{ hash = 1988219689, name = 'corolla2017', price = 350000, banido = false, modelo = 'Corolla', capacidade = 80, tipo = 'carros', slots = 10, rentalPrice = nil, class = "sedan"  },
	{ hash = -547156707, name = 'azera', price = 420000, banido = false, modelo = 'Azera', capacidade = 80, tipo = 'carros', slots = 10, rentalPrice = nil, class = "sedan"  },
	{ hash = -420911112, name = 'patriot2', price = 1500000, banido = false, modelo = 'Hummer Limousine', capacidade = 10, tipo = 'carros', slots = 10, rentalPrice = nil, class = "sedan "  },
	{ hash = -1961627517, name = 'stretch', price = 5000000, banido = false, modelo = 'Limousine Executiva', capacidade = 10, tipo = 'carros', slots = 10, rentalPrice = nil, class = "sedan "  },
...
-----------------------------------------------------------------------------------------------------------------------------------------
	...
	{ hash = -506359117, name = 'x6m', price = 6000000, banido = false, modelo = 'Bmw X6m', capacidade = 250, tipo = 'carros', slots = 10, rentalPrice = nil, class = "suv"  },
	{ hash = -125152048, name = 'bmwx1', price = 800000, banido = false, modelo = 'Bmw X1M', capacidade = 250, tipo = 'carros', slots = 10, rentalPrice = nil, class = "suv"  },
	{ hash = -110704625, name = 's10', price = 2600000, banido = false, modelo = 'S10', capacidade = 100, tipo = 'carros', slots = 10, rentalPrice = nil, class = "suv"  },
	{ hash = -590823126, name = 'hilux2022', price = 3000000, banido = false, modelo = 'Hilux', capacidade = 100, tipo = 'carros', slots = 10, rentalPrice = nil, class = "suv"  },
	{ hash = 137952352, name = 'sw4', price = 3500000, banido = false, modelo = 'Sw4', capacidade = 100, tipo = 'carros', slots = 10, rentalPrice = nil, class = "suv"  },
	{ hash = 284310455, name = 'xc90', price = 800000, banido = false, modelo = 'Volvo XC90', capacidade = 50, tipo = 'carros', slots = 10, rentalPrice = nil, class = "suv"  },
	{ hash = 408825843, name = 'outlaw', price = 360000, banido = false, modelo = 'Buggy Can Am', capacidade = 50, tipo = 'carros', slots = 10, rentalPrice = nil, class = "suv"  },
	{ hash = 1847017357, name = 'l200civil', price = 3000000, banido = false, modelo = 'L200', capacidade = 200, tipo = 'carros', slots = 10, rentalPrice = nil, class = "suv"  },
	{ hash = -1686080635, name = 'f250deboxe', price = 1800000, banido = false, modelo = 'F250', capacidade = 250, tipo = 'carros', slots = 10, rentalPrice = nil, class = "suv"  },
	{ hash = 1749763978, name = 'vw', price = 350000, banido = false, modelo = 'Kombi Surf', capacidade = 250, tipo = 'carros', slots = 10, rentalPrice = nil, class = "suv"  },

-----------------------------------------------------------------------------------------------------------------------------------------
-- SUPER
-----------------------------------------------------------------------------------------------------------------------------------------

	{ hash = 637861346, name = 'opala', price = 500000, banido = false, modelo = 'Opala', capacidade = 100, tipo = 'work', slots = 10, rentalPrice = nil, class = "super"  },
	{ hash = -157095615, name = 'bmwm3f80', price = 1800000, banido = false, modelo = 'Bmw M3', capacidade = 80, tipo = 'carros', slots = 10, rentalPrice = nil, class = "super"  },
	...
	{ hash = 874739883, name = 'c7', price = 2600000, banido = false, modelo = 'Corvette', capacidade = 30, tipo = 'carros', slots = 10, rentalPrice = nil, class = "super"  },
	...
	{ hash = -1728685474, name = 'coquette4', price = 2300000, banido = false, modelo = 'Corvette 2020', capacidade = 30, tipo = 'carros', slots = 10, rentalPrice = nil, class = "super"  },
	{ hash = -1485709732, name = '16ss', price = 1500000, banido = false, modelo = 'Camaro SS', capacidade = 30, tipo = 'carros', slots = 10, rentalPrice = nil, class = "super"  },
	{ hash = 723779872, name = 'toyotasupra', price = 7000000, banido = false, modelo = 'Toyota Supra', capacidade = 30, tipo = 'carros', slots = 10, rentalPrice = nil, class = "super" },
	...
	{ hash = 1769548661, name = 'c63w205', price = 1600000, banido = false, modelo = 'Mercedes C63', capacidade = 80, tipo = 'carros', slots = 10, rentalPrice = nil, class = "super"  },
	{ hash = 321186144, name = 'stafford', price = 1300000, banido = false, modelo = 'Stafford', capacidade = 30, tipo = 'carros', slots = 10, rentalPrice = nil, class = "super"  },
	{ hash = -13524981, name = 'bmwm4gts', price = 3500000, banido = false, modelo = 'Bmw M4', capacidade = 30, tipo = 'carros', slots = 10, rentalPrice = nil, class = "super"  },

-----------------------------------------------------------------------------------------------------------------------------------------
-- MOTOS
-----------------------------------------------------------------------------------------------------------------------------------------

	{ hash = 89762412, name = 'dt200', price = 50000, banido = false, modelo = 'DT 200', capacidade = 30, tipo = 'carros', slots = 10, rentalPrice = nil, class = "moto"  },
	{ hash = -913575190, name = 'bbros', price = 75000, banido = false, modelo = 'Bros 160', capacidade = 10, tipo = 'carros', slots = 10, rentalPrice = nil, class = "moto"   },
	...
	{ hash = -1591433303, name = 'start160', price = 45000, banido = false, modelo = 'CG Start 160', capacidade = 10, tipo = 'carros', slots = 10, rentalPrice = nil, class = "moto"  },
	{ hash = -1090539832, name = 'biz08', price = 35000, banido = false, modelo = 'Biz 125', capacidade = 30, tipo = 'carros', slots = 20, rentalPrice = nil, class = "moto"  },
	...
	{ hash = -1761239425, name = 'hornet', price = 1800000, banido = false, modelo = 'Hornet 600', capacidade = 10, tipo = 'carros', slots = 10, rentalPrice = nil, class = "moto"  },
	{ hash = -1129117794, name = 'xre2012', price = 120000, banido = false, modelo = 'Xre 300 Adventure', capacidade = 20, tipo = 'carros', slots = 10, rentalPrice = nil, class = "moto"   },
	...
	{ hash = -1874309937, name = '300', price = 180000, banido = false, modelo = 'CB 300', capacidade = 10, tipo = 'carros', slots = 10, rentalPrice = nil, class = "moto"   },
	{ hash = -1065246059, name = 'falcon', price = 200000, banido = false, modelo = 'Falcon 400', capacidade = 20, tipo = 'carros', slots = 10, rentalPrice = nil, class = "moto"    },
	...
	{ hash = 321407703, name = 'cbtwister', price = 280000, banido = false, modelo = 'CB Twister 250', capacidade = 10, tipo = 'carros', slots = 10, rentalPrice = nil, class = "moto"   },
	...
	{ hash = -558848462, name = 'cgmontadinha', price = 250000, banido = false, modelo = 'CG Montadinha', capacidade = 10, tipo = 'carros', slots = 10, rentalPrice = nil, class = "moto"  },
	...
	{ hash = 703607519, name = 'gs650', price = 1800000, banido = false, modelo = 'GS 650', capacidade = 30, tipo = 'carros', slots = 10, rentalPrice = nil, class = "moto"  },
	{ hash = -916334124, name = '250', price = 180000, banido = false, modelo = 'CG 250', capacidade = 10, tipo = 'carros', slots = 10, rentalPrice = nil, class = "moto"  },
	{ hash = 642762300, name = 'xrepcr', price = 150000, banido = false, modelo = 'Xre 300', capacidade = 20, tipo = 'carros', slots = 10, rentalPrice = nil, class = "moto"   },
